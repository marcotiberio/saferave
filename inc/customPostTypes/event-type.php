...
function registerEventTypePostType()
{
    $labels = [
        'name'                  => _x('Event Type', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Event Type', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Event Type', 'flynt'),
        'name_admin_bar'        => __('Event Type', 'flynt'),
    ...
    $args = [
        ...
        'description'           => __('Event Type Description', 'flynt'),
        'labels'                => $labels,
        'supports'              => ['title'],
        'taxonomies'            => ['category'],
        'hierarchical'          => false,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerEventTypePostType');
