...
function registerEventCapacityPostType()
{
    $labels = [
        'name'                  => _x('Event Capacity', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Event Capacity', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Event Capacity', 'flynt'),
        'name_admin_bar'        => __('Event Capacity', 'flynt'),
    ...
    register_post_type('event_capacity', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerEventCapacityPostType');
