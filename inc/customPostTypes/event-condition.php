...
function registerEventConditionPostType()
{
    $labels = [
        'name'                  => _x('Event Condition', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Event Condition', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Event Condition', 'flynt'),
        'name_admin_bar'        => __('Event Condition', 'flynt'),
    ...
    register_post_type('event_condition', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerEventConditionPostType');
