...
function registerEventResultPostType()
{
    $labels = [
        'name'                  => _x('Event Result', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Event Result', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Event Result', 'flynt'),
        'name_admin_bar'        => __('Event Result', 'flynt'),
    ...
    $args = [
        'label'                 => __('Event Result', 'flynt'),
        'description'           => __('Event Result Description', 'flynt'),
        'labels'                => $labels,
        'supports'              => ['title'],
        'taxonomies'            => ['category'],
        'hierarchical'          => false,
    ...
    register_post_type('event_result', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerEventResultPostType');
