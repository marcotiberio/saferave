...
function registerEventPrivacyPostType()
{
    $labels = [
        'name'                  => _x('Event Privacy', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Event Privacy', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Event Privacy', 'flynt'),
        'name_admin_bar'        => __('Event Privacy', 'flynt'),
    ...
    register_post_type('event_privacy', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerEventPrivacyPostType');
